...
public class BoardMgr {
	...
	private static final String SAVEFOLER = "업로드 파일 저장경로 입력 필수!"; 
	...
	public void insertBoard(HttpServletRequest req) {
		...
		try {
			...
			pstmt.setString(7, fileName); pstmt.setInt(8, fileSize); 
			pstmt.executeUpdate();
	...
	public Vector<BoardBean> getBoardList(String keyField, String keyWord, int start, int end) {
		...
		try {
			...
			if (keyWord.equals("null") || keyWord.equals("")) { // 검색어가 없을 경우
