...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1.0"> <title>회원가입동의</title>
...
<body>
	...
	<!-- 헤더템플릿 끝 -->
		...
		<!-- main#main -->
		<form id="joinFrm" method="post" action="/member/member.jsp"> <input type="hidden" name="vCode" value="chkOK1234">
		<div id="formArea">
